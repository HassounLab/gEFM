...
#define CARDINALITY32(n) BIT_COUNT_LOOKUP[n & 0xFF] + BIT_COUNT_LOOKUP[(n >> 8) & 0xFF] + BIT_COUNT_LOOKUP[(n >> 16) & 0xFF] + BIT_COUNT_LOOKUP[(n >> 24) & 0xFF]
//Computes cardinality of a 32-bit variable
#define CARDINALITY64(n) BIT_COUNT_LOOKUP[n & 0xFF] + BIT_COUNT_LOOKUP[(n >> 8) & 0xFF] + BIT_COUNT_LOOKUP[(n >> 16) & 0xFF] + BIT_COUNT_LOOKUP[(n >> 24) & 0xFF] + BIT_COUNT_LOOKUP[(n >> 32) & 0xFF] + BIT_COUNT_LOOKUP[(n >> 40) & 0xFF] + BIT_COUNT_LOOKUP[(n >> 48) & 0xFF] + BIT_COUNT_LOOKUP[(n >> 56) & 0xFF]
